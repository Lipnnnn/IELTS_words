// 用最简单的英语解释IELTS词汇
// 遵循原则：用常见的基础单词（1000常用词范围内）来解释复杂单词
...
export const simpleDefinitions = {
  ...
  'quartz': 'A hard shiny rock or glass',
...
// 获取简单释义
export function getSimpleDefinition(word) {
  return simpleDefinitions[word.toLowerCase().trim()] || null
}
